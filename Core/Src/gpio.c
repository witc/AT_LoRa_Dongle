...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SX1262_NSS_Pin|aux4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SX1262_RESET_Pin|LED_GREEN_Pin|aux3_Pin|aux2_Pin
                          |LED_BLUE_Pin|aux6_Pin|aux5_Pin|aux1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SX1262_NSS_Pin|aux4_Pin;
