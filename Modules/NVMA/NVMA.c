...
{
    HAL_FLASHEx_DATAEEPROM_Unlock();
    HAL_FLASHEx_DATAEEPROM_Program(FLASH_TYPEPROGRAMDATA_HALFWORD, EE_ADDR_LR_PREAM_SIZE_TX, size);
    HAL_FLASHEx_DATAEEPROM_Lock();
}
...
{
    HAL_FLASHEx_DATAEEPROM_Unlock();
    HAL_FLASHEx_DATAEEPROM_Program(FLASH_TYPEPROGRAMDATA_HALFWORD, EE_ADDR_LR_PREAM_SIZE_RX, size);
    HAL_FLASHEx_DATAEEPROM_Lock();
}
