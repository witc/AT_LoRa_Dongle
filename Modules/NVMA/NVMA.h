...
#define EE_ADDR_LR_TX_SF                        (EE_ADDR_LR_TX_POWER + sizeof(uint8_t))
#define EE_ADDR_LR_RX_SF                        (EE_ADDR_LR_TX_SF + sizeof(uint8_t))
#define EE_ADDR_LR_TX_BW                        (EE_ADDR_LR_RX_SF + sizeof(uint8_t))
#define EE_ADDR_LR_RX_BW                        (EE_ADDR_LR_TX_BW + sizeof(uint8_t))
#define EE_ADDR_LR_TX_IQ                        (EE_ADDR_LR_RX_BW + sizeof(uint8_t))
#define EE_ADDR_LR_RX_IQ                        (EE_ADDR_LR_TX_IQ + sizeof(uint8_t))
#define EE_ADDR_LR_TX_CR                        (EE_ADDR_LR_RX_IQ + sizeof(uint8_t))
#define EE_ADDR_LR_RX_CR                        (EE_ADDR_LR_TX_CR + sizeof(uint8_t))
#define EE_ADDR_LR_HEADERMODE_TX                (EE_ADDR_LR_RX_CR + sizeof(uint8_t))
#define EE_ADDR_LR_HEADERMODE_RX                (EE_ADDR_LR_HEADERMODE_TX + sizeof(uint8_t))
#define EE_ADDR_LR_CRC_TX                       (EE_ADDR_LR_HEADERMODE_RX + sizeof(uint8_t))
#define EE_ADDR_LR_CRC_RX                       (EE_ADDR_LR_CRC_TX + sizeof(uint8_t))
#define EE_ADDR_LR_PREAM_SIZE_TX                (EE_ADDR_LR_CRC_RX + sizeof(uint8_t))
#define EE_ADDR_LR_PREAM_SIZE_RX                (EE_ADDR_LR_PREAM_SIZE_TX + sizeof(uint16_t))
